...
$(function() {
    ...
    /*Finalement, si mode auto, on lance le déclenchement pour l'auto*/
    // if (auto_cb.prop('checked')) {
    //     declencher_auto(false);
    // }
...
//     var x = document.querySelector("#menu_principal").classList.toggle('open');
// });